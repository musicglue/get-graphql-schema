...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var argv, endpoint, defaultHeaders, method, headers, body, response, _a, data, errors, schema, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    method = argv['method'] || argv['m'] || 'POST';
                    ...
                    body = method === "GET" ? undefined : JSON.stringify({ query: introspectionQuery_1.introspectionQuery });
